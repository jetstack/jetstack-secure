...
// service-id without first removing its old credentials) and that choice is
// logged. Note this leaves the unused static credentials mounted in the pod;
// removing them is part of the migration, not something this code enforces.
